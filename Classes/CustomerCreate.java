...
public class CustomerCreate extends JFrame implements ActionListener
{
	...
	MyButton registerBtn, exitBtn, backBtn, ShowRecipeBtn;
	JPanel thisPannel;
...
public CustomerCreate()
{
	...
	dayComboBox.setCursor(new Cursor(Cursor.HAND_CURSOR));
	...
	monthComboBox.setCursor(new Cursor(Cursor.HAND_CURSOR));
	...
	yearComboBox.setCursor(new Cursor(Cursor.HAND_CURSOR));
	...
	CusType.setBounds(130, 550, 150, 20);
	thisPannel.add(CusType);

	NcusRadioButton = new JRadioButton("Free");
	NcusRadioButton.setCursor(new Cursor(Cursor.HAND_CURSOR));
	...
	PcusRadioButton.setCursor(new Cursor(Cursor.HAND_CURSOR));
